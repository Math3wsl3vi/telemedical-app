...
const Table = ({title, description}: {title:string; description:string})=> (
  <div className='flex flex-col items-start gap-2 xl:flex-row text-black'>
    <h1 className='text-base font-mediumctext-skt-1 lg:text-xl xl:min-w-32'>{title}</h1>
...
const router = useRouter()
 ...
 const meetingLink = `${process.env.NEXT_PUBLIC_BASE_URL}/meeting/${meetingId}?personal=true?leviIsAwesome`;
